...
import { setFirstLogin } from '../../../localStorage/localStorage';
...
function SignupForm({
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (actionCheckSignup.fulfilled.match(resultAction)) {
      dispatch(actionChangeOpenPopup({ content: 'Inscription réussie' }));
      setFirstLogin(); // Indiquer qu'il s'agit de la première connexion
